...
namespace Brik.Security.VkontakteMiddleware
{
    ...
    {
        private static readonly ResourceManager _resourceManager = new ResourceManager("Brik.Security.VkontakteMiddleware.Resources", typeof(Resources).GetTypeInfo().Assembly);
